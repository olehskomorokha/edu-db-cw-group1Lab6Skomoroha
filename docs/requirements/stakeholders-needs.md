...
нових опитувань, їх адміністрування та збору даних від учасників опитувань.*
...
збір інформації та аналізу даних, що здійснюється на платформі.*

*Продукт є онлайн-платформою для створення, проведення та аналізу опитувань,*
...
*   1. __Створити опитування:__ Клієнт може створювати нові опитування, вказуючи заголовок, опис та інші параметри.
    2. __Закрити опитування:__ Клієнт може завершити прийом відповідей на опитування, після чого система фіксує результат           та блокує можливість додавання нових відповідей.
    3. __Додати питання до опитування:__ Клієнт може додавати нові питання до вже створеного
       опитування, обираючи тип питання та формулюючи саме питання.
    4. __Видалити питання з опитування:__ Клієнт може видаляти непотрібні питання з опитування, що вже створене.
    5. __Отримати результати опитування:__ Клієнт може переглядати зібрані результати опитування,
       які включають статистику відповідей на кожне питання.
    6. __Експортувати результати опитування:__ Клієнт може експортувати результати опитування у
       різноманітні формати (наприклад, CSV або PDF) для подальшого аналізу чи збереження.
    7. __Поділитися опитуванням:__ Клієнт може надати доступ до опитування іншим користувачам,
       шляхом генерації унікального посилання чи іншими методами.*
**
*Функціональність для експерта:*
    1. __Пройти опитування:__ Експерт може приймати участь у вже створених опитуваннях,
       надаючи свої відповіді на запитання.
    2. __Змінити відповіді в опитуванні:__ Після завершення опитування, експерт може змінити свої
